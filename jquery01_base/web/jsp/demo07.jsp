...
<html>
		...
		<script type="text/javascript">
			...
			$(function() {
				$(arr).each(function(i, n) {
					$("#province").append("<option>"+n.province+"</option>");
				});
			...
			function select(index) {
				...
				var cities = arr[index].city;
				var _cities = cities.split("|");
				$(_cities).each(function(i, n) {
	...
	<body>
		籍　　贯：<select id="province" name="province" onchange="select(this.selectedIndex)"></select>
